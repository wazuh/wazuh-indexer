...
function usage() {
    ...
    # echo -e "-r REVISION\t[Optional] Package revision, default is '1'."
    echo -e "-o OUTPUT\t[Optional] Output path, default is 'artifacts'."
    echo -e "-D DRY\t[Optional] Output artifact name. Autogenerated."
    echo -e "-h help"
}

while getopts ":h:v:q:s:o:p:a:d:b:D" arg; do
    case $arg in
    h)
        usage
        exit 1
    ...
    b)
        ...
        ;;
    D)
        # Return the name of the package to be generated when no folder is provided with -o
        # This is useful in GH Actions to get the package name to download / upload in each 
        # of the CI steps.
        DRY=true
        ;;
    :)
