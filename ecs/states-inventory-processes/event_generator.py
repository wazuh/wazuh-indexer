...
def generate_random_process():
    process = {
        ...
        'pid': random.randint(1, 9999),
        'state': random.choice(['Running','Uninterruptible Sleep','Interruptable Sleep', 'Stopped', 'Zombie']),
...
def generate_random_unix_timestamp():
    ...
    random_time = start_date + datetime.timedelta(seconds=random.randint(0, int((end_time - start_time).total_seconds())))
