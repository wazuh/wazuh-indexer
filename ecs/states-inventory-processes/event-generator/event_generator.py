...
def generate_random_process():
    process = {
        'args': f'args{random.randint(0, 999)}',
        'command_line': f'command_line{random.randint(0, 999)}',
        'group': {
            'id': f'group_id{random.randint(0, 999)}'
        },
        'name': f'process{random.randint(0, 999)}',
        'parent': {
            'pid': random.randint(0, 99999)
        },
        'pid': random.randint(0, 99999),
        'real_group': {
            'id': f'real_group_id{random.randint(0, 999)}'
        },
        'real_user': {
            'id': f'real_user_id{random.randint(0, 999)}'
        },
        'saved_group': {
            'id': f'saved_group_id{random.randint(0, 999)}'
        },
        'saved_user': {
            'id': f'saved_user_id{random.randint(0, 999)}'
        },
        ...
        'user': {
            'id': f'user_id{random.randint(0, 999)}'
        }
    }
    return process
