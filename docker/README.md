...
```console
docker build --build-arg="VERSION=4.12.0" --build-arg="INDEXER_TAR_NAME=wazuh-indexer-4.11.2-1_linux-x64_cfca84f.tar.gz" --tag=wazuh-indexer:4.12.0--progress=plain --no-cache .
```
